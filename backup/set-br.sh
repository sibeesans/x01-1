...
echo "Checking VPS"
# Link Hosting Kalian
zenhost="raw.githubusercontent.com/Ysilven/sshxrayv3/main/backup"

apt install rclone -y
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "raw.githubusercontent.com/Ysilven/sshxrayv3/main/backup/rclone.conf"
